### ***Knockoutjs being translated***
---
This files ***html*** below is(should be) fully ***stand alone*** and able to be to be copied into a ***{something}.html*** file to see the ***original purpose***.

The html when ***loaded in browser*** should show the following. A ***chart*** will load data ***differently*** each load for demo reason.

### ***Chart Axis:***
- Time axis
- Price Progress (Normalized) axis

### ***Data plotted:***
- Actual Price Progress - Dynamic data line
- Expected Price Progress (String) - Straight line from buying price to wanted price over the time frame
- Scalping Exit - The threshold line that if passed signals a safe exit.
- Trajectory Arc (Bow) - This is a visual of a risk allowance on the movement before monitoring/managing is flagged 
...
<head>
  ...
  <title>Trajectory Arc with Background Fill</title>
  <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/chartjs-adapter-date-fns"></script> <!-- For time axis support -->
  <style>
    canvas {
      width: 100%;
      max-width: 800px;
  ...
  <script>
    ...
    function generateOscillatingData(entryPrice, targetPrice, numPoints) {
      ...
      for (let i = 0; i < numPoints; i++) {
        // Oscillation: add a random value to simulate market fluctuations
